...
void TPart_id::InitHistos(void){
  ...
  Acc_acc->Add(reconstructed_evnt_bin[0] = new TH1F("reconstructed_evnt_bin_liq","Reconstructed Event binning liquid",4320, 0, 4320));
  Acc_acc->Add(reconstructed_evnt_bin[1] = new TH1F("reconstructed_evnt_bin_sol","Reconstructed Event binning solid",4320, 0, 4320));
  Acc_acc->Add(generated_evnt_bin = new TH1F("generated_evnt_bin","Generated Event binning",4320, 0, 4320));
  Acc_acc->Add(deforming_matrix_inv = new TH2F("deforming_matrix_inv","Inverse of bin migration of reconstructed Event",4320,0,4320,4320,0,4320));
...
Int_t TPart_id::Acceptance_data(Int_t i){
  ...
  if (Q2_v >0.7 && Q2_v <2.5 && W_v>1.8 && W_v<3 && t_v>0.1 && t_v<0.4 && theta_pip_v>0 &&  theta_pip_v< (TMath::Pi())) {
