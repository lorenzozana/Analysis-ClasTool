//
// File generated by /net/data/pumpkin1/lzana/root/bin/rootcint at Wed Feb 11 12:45:58 2009
...
/********************************************************
* dicts/Linux64RHEL5/fidc_cut_allDict.cc
...
/* TFidCut */
static int G__fidc_cut_allDict_527_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   TFidCut* p = NULL;
...
static int G__fidc_cut_allDict_527_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((TFidCut*) G__getstructoffset())->CheckCut(*((TVector3*) G__int(libp->para[0]))));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__fidc_cut_allDict_527_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((TFidCut*) G__getstructoffset())->CheckCutPim(*((TVector3*) G__int(libp->para[0]))));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__fidc_cut_allDict_527_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__fidc_cut_allDict_527_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__fidc_cut_allDict_527_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__fidc_cut_allDict_527_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memfuncTFidCut(void) {
   ...
   G__memfunc_setup("TFidCut",659,G__fidc_cut_allDict_527_0_1, 105, G__get_linked_tagnum(&G__fidc_cut_allDictLN_TFidCut), -1, 0, 2, 1, 1, 0, 
"C - 'Char_t' 0 - FileName i - 'Int_t' 0 - part", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("CheckCut",778,G__fidc_cut_allDict_527_0_2, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "u 'TVector3' - 0 - Vector", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("CheckCutPim",1072,G__fidc_cut_allDict_527_0_3, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "u 'TVector3' - 0 - Vector", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Get_Par",674,G__fidc_cut_allDict_527_0_4, 100, -1, G__defined_typename("Double_t"), 0, 4, 1, 1, 0, 
"i - 'Int_t' 0 - sec i - 'Int_t' 0 - side "
"i - 'Int_t' 0 - param d - 'Double_t' 0 - mom", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("TFidCut", 659, G__fidc_cut_allDict_527_0_5, (int) ('i'), G__get_linked_tagnum(&G__fidc_cut_allDictLN_TFidCut), -1, 0, 1, 1, 1, 0, "u 'TFidCut' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TFidCut", 785, G__fidc_cut_allDict_527_0_6, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__fidc_cut_allDict_527_0_7, (int) ('u'), G__get_linked_tagnum(&G__fidc_cut_allDictLN_TFidCut), -1, 1, 1, 1, 1, 0, "u 'TFidCut' - 11 - -", (char*) NULL, (void*) NULL, 0);
